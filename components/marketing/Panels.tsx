...
const PANELS: Panel[] = [
  ...
  { id: 'industries', img: '/team-men.webp', tone: 'photo', title: { ru: 'Направления', az: 'İstiqamətlər', en: 'Areas' }, chips: { ru: ['5 готовых разделов'], az: ['5 hazır bölmə'], en: ['5 ready sections'] }, href: () => '#industries' },
