...
const COPY = {
  az: {
    ...
    note: 'Yer yalnız aktiv iş günü ərzində toplanır; tətbiq bunu bildirişlə və «Bu gün» ekranında göstərir. Tezliklə Google Play-da.',
  ...
  ru: {
    ...
    note: 'Местоположение собирается только в активный рабочий день; приложение показывает это уведомлением и на экране «Сегодня». Скоро в Google Play.',
  ...
  en: {
    ...
    note: 'Location is collected only during an active workday; the app shows this in a notification and on the Today screen. Coming soon to Google Play.',
