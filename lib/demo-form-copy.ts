...
export const DEMO_FORM: Record<Lang, {
  ...
  az: {
    ...
    submit: 'Sorğu göndər', sending: 'Göndərilir…', or: 'və ya', whatsapp: 'WhatsApp-da yazın', consent: '', consentLabel: 'Fərdi məlumatlarımın demo sorğusuna cavab vermək məqsədilə emalına razıyam:', consentLink: 'Məxfilik siyasəti', consentRequired: 'Razılıq olmadan sorğu göndərilə bilməz',
  ...
  ru: {
    ...
    submit: 'Отправить запрос', sending: 'Отправляем…', or: 'или', whatsapp: 'Написать в WhatsApp', consent: '', consentLabel: 'Согласен на обработку персональных данных для ответа на запрос демо:', consentLink: 'Политика конфиденциальности', consentRequired: 'Без согласия отправить запрос нельзя',
  ...
  en: {
    ...
    submit: 'Send request', sending: 'Sending…', or: 'or', whatsapp: 'Write on WhatsApp', consent: '', consentLabel: 'I agree to the processing of my personal data to answer this demo request:', consentLink: 'Privacy Policy', consentRequired: 'The request cannot be sent without consent',
